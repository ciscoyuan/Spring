...
public class GoodsGroupController {
    ...
    public Object list(@RequestParam(required = false, value = "offset", defaultValue = "0") int offset,
        ...
        return goodsGroupService.listPageByExample(example);
    }
    ...
    public Object get(@PathVariable("id") Integer id) {
        ...
        return goodsGroupService.selectByPrimaryKey(id);
    }
    
	@RequestMapping(value = "/add", method = RequestMethod.POST)
	@ResponseBody
	public Object create(GoodsGroup goodsGroup) {
    ...
    @ResponseBody
    public Object update(GoodsGroup goodsGroup) {
