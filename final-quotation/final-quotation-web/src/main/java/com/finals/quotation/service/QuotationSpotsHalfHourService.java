...
/**
 * QuotationSpotsHalfHour Service接口
 * @author auto generate v1.0
 * @version 1.0, 2017/12/10
 */
public interface QuotationSpotsHalfHourService extends BaseService<QuotationSpotsHalfHour, QuotationSpotsHalfHourExample> {
